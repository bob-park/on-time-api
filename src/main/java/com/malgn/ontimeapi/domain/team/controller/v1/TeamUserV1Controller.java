...
public class TeamUserV1Controller {
    ...
    @PutMapping(path = "")
    public TeamResponse updateTeamUser(@PathVariable long teamId,
        @RequestBody UpdateTeamUserV1Request updateRequest) {
        return teamUserService.updateTeamUser(Id.of(Team.class, teamId), updateRequest);
    }
